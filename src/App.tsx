        ...
        {(currentPath === '/' || (currentPath !== '/parent' && currentPath !== '/kid')) && (
          <div key="home" className="flex flex-col items-center justify-center min-h-screen p-6 max-w-md mx-auto">
            <div className="mb-12 text-center">
              ...
              <p className="text-slate-500 font-medium">Digital Success Box</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="opacity-80 font-medium">Log a success note</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  <h2 className="text-2xl font-bold">Kid Mode</h2>
                  <p className="opacity-80 font-medium">View success box</p>
                </div>
              </a>
            </div>
          </div>
